...
class PelinsPage extends StatefulWidget {
  PelinsPage({Key? key}) : super(key: key);

  @override
  _PelinsPageState createState() => _PelinsPageState();
}

class _PelinsPageState extends State<PelinsPage> {
  ...
  void initBackground() async {
    ...
    final image = await AssetImage("lib/images/pelinandme.jpeg").image;
